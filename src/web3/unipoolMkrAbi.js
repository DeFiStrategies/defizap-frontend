const UNIPOOL_MKR_ABI = [
    ...
    inputs: [
      {
        ...
        name: '_new_MKR_TokenContractAddress',
        type: 'address'
      }
    ],
    name: 'set_new_MKR_TokenContractAddress',
    outputs: [],
    payable: false,
    stateMutability: 'nonpayable',
    type: 'function'
  },
  {
    inputs: [
      {
        internalType: 'address',
        name: '_MKR_TokenContractAddress',
        type: 'address'
      },
      {
...
export default UNIPOOL_MKR_ABI;
