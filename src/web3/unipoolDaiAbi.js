const UNIPOOL_DAI_ABI = [
    ...
    inputs: [
      {
        ...
        name: '_new_DAI_TokenContractAddress',
        type: 'address'
      }
    ],
    name: 'set_new_DAI_TokenContractAddress',
    outputs: [],
    payable: false,
    stateMutability: 'nonpayable',
    type: 'function'
  },
  {
    inputs: [
      {
        internalType: 'address',
        name: '_DAI_TokenContractAddress',
        type: 'address'
      },
      {
...
export default UNIPOOL_DAI_ABI;
