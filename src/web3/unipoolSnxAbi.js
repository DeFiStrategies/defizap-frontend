const UNIPOOL_SNX_ABI = [
  {
    inputs: [
      {
        internalType: 'address',
        name: '_SNX_TokenContractAddress',
        type: 'address'
      },
      {
  ...
  },
  {
    ...
    inputs: [
      {
        internalType: 'address',
        name: '_new_SNX_TokenContractAddress',
        type: 'address'
      }
    ],
    name: 'set_new_SNX_TokenContractAddress',
    outputs: [],
    payable: false,
    stateMutability: 'nonpayable',
    type: 'function'
...
export default UNIPOOL_SNX_ABI;
