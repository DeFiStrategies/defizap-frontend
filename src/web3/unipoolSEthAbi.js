const UNIPOOL_SETH_ABI = [
  {
    inputs: [
      {
        internalType: 'address',
        name: '_sETH_TokenContractAddress',
        type: 'address'
      },
      {
  ...
  },
  {
    constant: true,
    inputs: [],
    name: 'sETH_TokenContractAddress',
    outputs: [
      {
        internalType: 'address',
        name: '',
  ...
  },
  {
    ...
    inputs: [
      {
        internalType: 'address',
        name: '_new_sETH_TokenContractAddress',
        type: 'address'
      }
    ],
    name: 'set_new_sETH_TokenContractAddress',
    outputs: [],
    payable: false,
    stateMutability: 'nonpayable',
    type: 'function'
...
export default UNIPOOL_SETH_ABI;
